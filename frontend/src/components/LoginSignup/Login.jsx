      ...
      if (userDetails) {
        ...
        setTimeout(() => {
          if (userDetails.role === "jobSeeker") {
            if (userDetails.userProfile.doneOnboarding === true) {
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-3/6 pt-7 sm:pt-14 md:w-2/5">
          <div className="p-3 sm:p-10">
            ...
            <p className="mt-3">Welcome back! Let's find your next opportunity.</p>
            <form className="mt-6" onSubmit={handleFormSubmission}>
              <div className="flex flex-col">
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="bg-black rounded-md text-white font-normal text-sm h-11 hover:bg-gray-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {loading && (
