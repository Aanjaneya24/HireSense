...
function Navbar() {
  ...
  const activeStyle = "text-blue-700 pb-4 border-b-2 border-blue-700";
        ...
        >
          ...
          {!status ? (
            <div className=" lg:flex ">
              <Link to="/login">
                <button className="border border-gray-300 text-black font-bold py-1.5 px-5 rounded-md lg:ml-32 lg:ml-7 lg:shadow xl:ml-36 hover:bg-blue-50 hover:border-blue-500 duration-500 mr-5 lg:hover:scale-105">
                  Login
                </button>
              </Link>
              <Link to="/signup">
                <button className="bg-black text-white font-bold py-1.5 px-5 rounded-md lg:ml hover:bg-blue-700 duration-500 lg:hover:scale-105 lg:shadow">
                  Sign Up
                </button>
              </Link>
            </div>
